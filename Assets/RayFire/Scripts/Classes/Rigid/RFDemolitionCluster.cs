...
namespace RayFire
{
    ...
    public class RFDemolitionCluster
    {
        ...
        public static bool Clusterize (RayfireRigid scr)
        {
            ...
            RayfireUnyielding.SetRigidUnyielding (scr);
        ...
        public static void DemolishConnectedCluster (RayfireRigid scr, Collider[] detachColliders = null)
        {
            ...
            // TODO fix bug; uny frags removes from cluster but then stop at UnyieldingByShardAll check
            ...
            // TODO BUG
            // if only uny shards -> detaches from cluster but stay as children
            // if uny shards and not uny shards together -> detaches from cluster AND change parent
            ...
            // All detach shards uny if kinematic/inactive cluster TODO add to slice, collapse
